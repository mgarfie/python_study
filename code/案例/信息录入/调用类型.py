...
class _table(App):
    ...
    # def win_table(self):
        ...
        # 创建表格
        self.tree = ttk.Treeview(self._Frame.frame5, columns=(
        'col1', 'col2', 'col3', 'col4', 'col5', 'col6', 'col7', 'col8', 'col9', 'col10', 'col11'))
        self.tree.column('#0', width=100, stretch=NO)
        self.tree.column('col1', width=100, stretch=NO)
        self.tree.column('col2', width=100, stretch=NO)
        self.tree.column('col3', width=100, stretch=NO)
        self.tree.column('col4', width=100, stretch=NO)
        self.tree.column('col5', width=100, stretch=NO)
        self.tree.column('col6', width=100, stretch=NO)
        self.tree.column('col7', width=100, stretch=NO)
        self.tree.column('col8', width=100, stretch=NO)
        self.tree.column('col9', width=100, stretch=NO)
        self.tree.column('col10', width=100, stretch=NO)
        self.tree.column('col11', width=100, stretch=NO)
        # 设置列标题
        self.tree.heading('#0', text='ID')
        self.tree.heading('col1', text='标准1')
        self.tree.heading('col2', text='标准2')
        self.tree.heading('col3', text='标准3')
        self.tree.heading('col4', text='标准4')
        self.tree.heading('col5', text='标准5')
        self.tree.heading('col6', text='标准6')
        self.tree.heading('col7', text='标准7')
        self.tree.heading('col8', text='标准8')
        self.tree.heading('col9', text='标准9')
        self.tree.heading('col10', text='标准10')
